...
export class AmountService {
    ...
    find(id: number): Observable<EntityResponseType> {
        return this.http
            .get<Amount>(`${this.resourceUrl}/${id}`, {observe: 'response'});
    }
    ...
    create(amount: Amount): Observable<HttpResponse<any>> {
        return this.http
            .post<any>(this.resourceUrl, amount, {observe: 'response'});
    }

    update(amount: Amount): Observable<HttpResponse<any>> {
        return this.http
            .put<any>(`${this.resourceUrl}/${amount.id}`, amount, {observe: 'response'});
    }
