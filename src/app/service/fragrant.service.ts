...
export class FragrantService {
    ...
    find(id: number): Observable<EntityResponseType> {
        return this.http
            .get<Fragrant>(`${this.resourceUrl}/${id}`, {observe: 'response'});
    }
    ...
    create(fragrant: Fragrant): Observable<HttpResponse<any>> {
        return this.http
            .post<any>(this.resourceUrl, fragrant, {observe: 'response'});
    }

    update(fragrant: Fragrant): Observable<HttpResponse<any>> {
        return this.http
            .put<any>(`${this.resourceUrl}/${fragrant.id}`, fragrant, {observe: 'response'});
    }
